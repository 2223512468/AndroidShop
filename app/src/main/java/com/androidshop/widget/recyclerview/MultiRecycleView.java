package com.androidshop.widget.recyclerview;
...
//        mRecyclerView.setLayoutManager(manager);
    ...
    private EndlessRecyclerOnScrollListener mOnScrollListener = new EndlessRecyclerOnScrollListener() {
        ...
        public void onLoadNextPage(View view) {
            ...
            boolean isloadmore = RecyclerViewStateUtils.setFooterViewState(mContext, mRecyclerView, Constant.PAGE_LIMIT, LoadingFooter.State.LoadingMore, null);
            if (isloadmore) {
